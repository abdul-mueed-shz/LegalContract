...
func TestCreateAsset(t *testing.T) {
	...
	contract := chaincode.SmartContract{}
	err := contract.CreateAsset(transactionContext, "asset1", "Project Alpha", "Initial phase", []string{"Alice", "Bob"})
	require.NoError(t, err)
...
func TestReadAsset(t *testing.T) {
	...
	expectedAsset := &chaincode.Asset{ID: "asset1", Title: "Project Alpha", Description: "Initial phase", Participants: []string{"Alice", "Bob"}}
	...
	chaincodeStub.GetStateReturns(nil, fmt.Errorf("unable to retrieve asset"))
	_, err = contract.ReadAsset(transactionContext, "asset1")
	require.EqualError(t, err, "failed to read from world state: unable to retrieve asset")
...
func TestUpdateAsset(t *testing.T) {
	...
	chaincodeStub.GetStateReturns(bytes, nil)
	contract := chaincode.SmartContract{}
	err = contract.UpdateAsset(transactionContext, "asset1", "Project Beta", "Development phase", []string{"Alice", "Charlie"})
	require.NoError(t, err)
...
func TestDeleteAsset(t *testing.T) {
	...
	asset := &chaincode.Asset{ID: "asset1", Title: "Project Alpha", Description: "Initial phase", Participants: []string{"Alice", "Bob"}}
